...
-- ---------------------------------------
-- 	Le mode d'automation est choisi par des Selector switches (Virtual Switch) à créer dans Domoticz.
--	- Mode 'Manuel' : Arrêt de l'automation.
--
--	- Mode 'Jour/Nuit' : Ouverture/Fermeture (ou On/Off) au lever/coucher de soleil.
--		- Ouverture (On): commande envoyée à l'heure du lever du soleil + TIME_DAY_OFFSET avec une
--		  heure minimum définie par TIME_MINIMUM.
--		- Fermeture (Off): commande envoyée à l'heure du coucher du soleil + TIME_NIGHT_OFFSET.
--
--	- Mode 'BioClim' : Jour/Nuit + Fermeture partielle des volets par plages horaires.
...
--          (voir le script Selector_Mode_Volets.lua).
...
--	4) Copier dans /home/pi/domoticz/scripts/lua/ : 
